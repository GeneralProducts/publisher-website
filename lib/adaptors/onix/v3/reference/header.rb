      ...
      class Reference
        class Header
          def initialize(header_node)
            raise "Not expecting a #{header_node.class}" unless header_node.is_a? Nokogiri::XML::Element
            # Thanks for the thing called "header_node"
            # We're going to save it in an instance variable also called "header_node"
